...
resource "aws_eks_addon" "addon" {
  ...
  service_account_role_arn = var.eks_addons_info.iam_role.create ? aws_iam_role.this[0].arn : null
  ...
  resolve_conflicts        = try(var.eks_addons_info.resolve_conflicts, "NONE")
}
